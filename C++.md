...
效率和个人习惯的培养：程序调试的思路一般为: 分析现象 -> 假设错误原因 -> 产生新的现象去验证。IDE的断点调试，点击鼠标就可以设置断点，使用GDB调试像拿着胶卷相机去拍照，调试的步骤要经过仔细考虑，一定程度上会加深思考，长期养成好习惯，工作效率也会提高。
